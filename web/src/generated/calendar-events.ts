...
export const VEYDRIA_CALENDAR_EVENTS: CalendarEvent[] = [
...

  {
    ...
    startDay: 80,
    durationDays: 14,
    description: 'Transition from wet monsoon to SE trade season. Cyclone risk peaks; convoy-departure windows are declared by the priestess-queen.',
...

  {
    ...
    startDay: 270,
    durationDays: 14,
    description: 'Transition from SE trade season back to wet monsoon. The Harbor Covenant reviews wave-tithe terms.',
    season: 'autumn',
  },
...

  {
    ...
    startDay: 355,
    durationDays: 5,
    description: 'Annual solstice consecration of the New Harvest by the priestess-queen in dual-aspect register (ocean-salt + hearth-fire). The only fixed point of the Oravan year.',
...

  {
    ...
    startDay: 90,
    durationDays: 7,
    description: 'Cyclone-shoulder convoy blessing declared by the priestess-queen after observation. No vessel may sail uninsured before this rite.',
    season: 'spring',
  },

  {
    ...
    startDay: 200,
    durationDays: 7,
    description: 'The Harbor Covenant collects the seasonal wave-tithe from every vessel that sailed under its insurance window.',
    season: 'summer',
  },

  {
    ...
    startDay: 130,
    durationDays: 90,
    description: 'Upland rains drive the A-Tzalan flood rise. River traffic becomes unpredictable and gauge-readings climb.',
    season: 'spring',
  },
...

  {
    ...
    startDay: 265,
    durationDays: 7,
    description: 'The Floodwatch Augmented Bureaucracy publishes the annual flood-window prediction. Classifies the year as ordinary, heavy, or low flood.',
...

  {
    ...
    startDay: 272,
    durationDays: 7,
    description: 'Ratification session convened the week after flood-window publication. River-lords vote on levy apportionment.',
...

  {
    ...
    startDay: 55,
    durationDays: 20,
    description: 'Late dry season when granary reserves run critical. Vernacular-Habal pamphlets circulate at river-market fairs.',
    season: 'winter',
  },
...

  {
    ...
    startDay: 30,
    durationDays: 7,
    description: 'Twice-yearly Imajīn Caravan Council meeting at Tin-Aghīz. Cool-season caravan-opening declared by Azmarāʔ scholars.',
    season: 'winter',
  },

  {
    ...
    startDay: 210,
    durationDays: 7,
    description: 'Autumn session of the Imajīn Caravan Council. Dust-tithe pool adjustments ratified for the remaining caravan rotations.',
    season: 'summer',
  },

  {
    ...
    startDay: 355,
    durationDays: 15,
    description: 'Peak period for Azmarāʔ star-readings. Qalibin scholars compute caravan-season openings from desert-interior water-lore.',
    season: 'winter',
  },

  {
    ...
    startDay: 230,
    durationDays: 7,
    description: 'Mid-to-late-summer drought classification by the Water-Allocation Court. Governs Ḥārrā Tappers\' League harvest certification.',
...

  {
    ...
    startDay: 340,
    durationDays: 45,
    description: 'Horses paw through snow; temperatures drop to –40 °C. Dzud risk peaks; Bokh Heresy Watchers monitor monthly.',
    season: 'winter',
  },
...

  {
    ...
    startDay: 310,
    durationDays: 14,
    description: 'Autumn Oral-Memory Council hearing that ratifies the year\'s grazing-circuit allocation. The operational load-bearing decision of the Kheshkai year.',
    effect: 'Unratified disputes force clans to overwinter on contested pasture without Council-Varkosh validation.',
    season: 'autumn',
  },
...

  {
    ...
    startDay: 290,
    durationDays: 21,
    description: 'Late-autumn freeze-and-trample processing of bitter tubers into chuño. Alternating hard freezes and foot-trampling determine the year\'s caloric reserve.',
    season: 'autumn',
  },

  {
    ...
    startDay: 15,
    durationDays: 20,
    description: 'Cold dry season when highland passes open to Kheshkai caravan traffic. Corridor-gating tariff windows are declared by the calendar-keepers.',
...

  {
    ...
    startDay: 355,
    durationDays: 89,
    description: 'The ~89-day window between winter solstice and spring equinox disputed by the Alto Concordance and Upriver Confederation. Every date inside is "correct" under one lineage and "wrong" under the other.',
    effect: 'Oaths sworn during this window are valid by one lineage and void by the other. Double-dated contracts are standard in Basin commerce.',
    season: 'winter',
  },
...

  {
    ...
    startDay: 355,
    durationDays: 5,
    description: 'Annual solstice festival (Lapam Bla-\'Bangs Cho-Ga). The only occasion all six Ngaru-Bon factions occupy the same space. Gold-work consecration of the festival flame is the liturgical climax.',
    effect: 'If Inner Council and Outside-Forge Network disagree on the presiding Lapam-tier candidate, the year\'s tool-reconsecration cycle is invalidated.',
    season: 'winter',
  },
...

  {
    ...
    startDay: 15,
    durationDays: 30,
    description: 'Triple-Seal Court convenes at Tavakh-Qarat (north shore) during the Mediterranean cool season. Khazadari cross-rate sessions and arbitration-panel sittings in the Arcade of Scales.',
    season: 'winter',
  },

  {
    ...
    startDay: 320,
    durationDays: 50,
    description: 'Triple-Seal Court convenes at Ki-Mbuhari (south shore) during the Ndjadi flood-recede. Prefix-notarization economy at its busiest.',
    season: 'winter',
  },

  {
    ...
    startDay: 110,
    durationDays: 30,
    description: 'Triple-Seal Court convenes at Halani-Tamu (east shore) during the monsoon lull. Qalībin Lodges at peak certification activity.',
    season: 'spring',
  },

  {
    ...
    startDay: 270,
    durationDays: 30,
    description: 'Triple-Seal Court convenes at Dzong-Tamu (southeast margin) during the Ngaru-Bon harvest-bridge. Iron Keep and Click-Market at peak commercial activity.',
    season: 'autumn',
  },

  {
    ...
    startDay: 1,
    durationDays: 7,
    description: 'Khazadari Inner Circle publishes cross-rate schedules for the six major currency-traded commodities. Every port\'s warehouse-factors must adjust contract terms within thirty days.',
...

  {
    ...
    startDay: 45,
    durationDays: 7,
    description: 'The Triple-Seal Court packs up at Tavakh-Qarat and reconvenes at Ki-Mbuhari. Contracts straddling the transition are flagged for procedural review.',
    season: 'winter',
  },

  {
    ...
    startDay: 135,
    durationDays: 7,
    description: 'Court rotation from Ki-Mbuhari to Halani-Tamu. Receiving-port senior arbitrators may ratify or remand contracts whose validity windows cross the transition.',
    season: 'spring',
  },
